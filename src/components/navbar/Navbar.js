...
function Navbar() {
     ...
     const lightModeEnabled = typeof isLight !== "undefined"
          ? isLight
          : window.matchMedia("(prefers-color-scheme: light)").matches

     //Adds Light mode to the className
     useEffect(() => {
          ...
          try {
               window.localStorage.setItem(key, lightModeEnabled) // Setting in local storage by key
          }
          catch (e) {
     ...
     return (
          <div className="navbar">
               ...
               <div className="nav-links">
                    {isLight ? (
                         <svg onClick={() => setIsLight(!isLight)} className="dark-mode" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 385 385">
                         ...
                         <svg onClick={() => setIsLight(!isLight)} className="light-mode" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 385 385">
                              <g id="Group_2" data-name="Group 2" transform="translate(-4442 -1720)">
                                   <g id="Group_1" data-name="Group 1" transform="translate(-15 74)">
                                        <rect id="Rectangle_12" data-name="Rectangle 12" width="385" height="385" transform="translate(4457 1646)" fill="none" />
                                   </g>
